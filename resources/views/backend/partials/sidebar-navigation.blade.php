<aside id="sidebar" class="sidebar c-overflow">
    ...
    <ul class="main-menu main-ul">
        ...
        @if (app('plugins')->plugins()->count() > 0)
            <li id="plugin-menu-toggle"><a href="#"><i class="zmdi zmdi-device-hub"></i> Plugins <span class="plugin-chevron pull-right"><i class="zmdi zmdi-chevron-down"></i></span></a></li>
            <ul class="plugin-menu plugin-ul">
                @foreach (app('plugins')->plugins() as $plugin)
                    <li><a href="{{ url('admin') }}"><i class="zmdi zmdi-input-power"></i> {{ $plugin->name() }} Plugin</a></li>
                @endforeach
            </ul>
        @endif
